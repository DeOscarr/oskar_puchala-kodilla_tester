...
class CalculatorTestSuite {
    ...
    public void shouldAddDoubleValues() {
        ...
        Assertions.assertEquals(8.5, calculator.add(3.5, 5.0), 0.01);
    }
    ...
    public void shouldSubtractDoubleValues() {
        ApplicationContext context = new AnnotationConfigApplicationContext("com.kodilla.spring.basic.spring_dependency_injection.homework");
        Calculator calculator = context.getBean(Calculator.class);
        Assertions.assertEquals(3.5, calculator.subtract(7.5, 4.0), 0.01);
    }
    ...
    public void shouldDivideDoubleValues() {
        ApplicationContext context = new AnnotationConfigApplicationContext("com.kodilla.spring.basic.spring_dependency_injection.homework");
        Calculator calculator = context.getBean(Calculator.class);
        Assertions.assertEquals(3.0, calculator.divide(9.0, 3.0), 0.01);
    }
}